  ...
  useEffect(() => {
    fetch(`/api/admin/kajian/${id}`, {
      ...
      .then((k) => {
        ...
        setDateLabel(k.date_label);
        setDateStart(k.date_start ? String(k.date_start).slice(0, 10) : "");
        setTimeLabel(k.time_label);
        setSpeaker(k.speaker || "");
        setLocation(k.location || "");
        setDescription(k.description || "");
        setImageUrl(k.image_url || "");
        setCapacity(k.capacity || "");
        setIsRecurring(k.is_recurring);
        setRecurringDay(k.recurring_day || "");
        setIsPublished(k.is_published);
        setLoading(false);
      });
  }, [id]);
