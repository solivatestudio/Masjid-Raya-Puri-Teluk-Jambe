...
import { formatRupiah, formatDateShort, fillDailyViews } from '../../lib/utils';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-3xl border border-slate-100 card-shadow p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link to="/dashboard/keuangan" className="text-[10px] font-bold text-emerald-600 hover:text-emerald-800 flex items-center gap-1">
        ...
        <div className="bg-white rounded-3xl border border-slate-100 card-shadow p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link to="/dashboard/booking" className="text-[10px] font-bold text-emerald-600 hover:text-emerald-800 flex items-center gap-1">
              Lihat Semua <ArrowRight className="w-3 h-3" />
            </Link>
          </div>
          <div className="space-y-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-3xl border border-slate-100 card-shadow p-5">
          ...
          <div className="space-y-3">
            <Link to="/dashboard/keuangan"
              className="block w-full text-center bg-emerald-50 hover:bg-emerald-100 text-emerald-800 text-xs font-bold py-3 rounded-xl transition">
              + Tambah Transaksi
            </Link>
            <Link to="/dashboard/booking"
              className="block w-full text-center bg-amber-50 hover:bg-amber-100 text-amber-800 text-xs font-bold py-3 rounded-xl transition">
              📋 Review Booking
            </Link>
            <Link to="/dashboard/trafik"
              className="block w-full text-center bg-blue-50 hover:bg-blue-100 text-blue-800 text-xs font-bold py-3 rounded-xl transition">
              📊 Lihat Trafik
            </Link>
          </div>
        </div>
