...
export default function DonationSection() {
  ...
  return (
    <section
      id="donasi"
      className="py-20 emerald-gradient text-white relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <p className="mt-3 text-base text-emerald-200">
            &ldquo;Perumpamaan orang yang menafkahkan hartanya di jalan Allah
            adalah serupa dengan sebutir benih yang menumbuhkan tujuh
            bulir.&rdquo; (QS. Al-Baqarah: 261)
          </p>
        </div>
          ...
          <div className="lg:col-span-5 flex flex-col items-center">
            <div className="bg-white text-gray-900 rounded-3xl p-6 shadow-2xl max-w-sm w-full border-4 border-amber-400 relative overflow-hidden flex flex-col items-center">
              ...
              <div className="text-center pb-3 border-b border-gray-100 w-full mb-3">
                ...
                <p className="text-[9px] text-emerald-700 bg-emerald-50 inline-block px-1.5 py-0.5 rounded font-black mt-1">
              ...
              <div className="w-full mt-4 bg-gray-50 rounded-xl p-3 text-center border border-gray-100">
                <span className="block text-[9px] text-gray-500 mt-0.5">
                  Silakan scan kode QRIS gratis biaya admin
                </span>
              </div>
            </div>
            <div className="mt-4 flex items-center gap-2.5 bg-emerald-900/40 text-emerald-300 font-medium border border-emerald-800 rounded-xl px-4 py-2.5 text-xs max-w-sm w-full">
              ...
              <span>
                Dapat dipindai dari kamera HP atau Semua aplikasi dompet
                digital.
              </span>
            </div>
          </div>
            ...
            >
              ...
              <div className="pt-2 border-t border-emerald-800">
                ...
                <p className="text-[10px] text-emerald-300/80 text-center mt-3 leading-tight italic">
                  * Tombol konfirmasi di atas memfasilitasi anda untuk
                  mengkonfirmasi melalui whatsapp admin
                </p>
              </div>
            </form>
            ...
            <div className="bg-emerald-900/10 border border-emerald-800/60 rounded-2xl p-6 space-y-4">
              <div className="flex items-center gap-2">
                ...
                <h4 className="font-bold text-sm">
                  Metode Alternatif: Layanan Transfer Perbankan
                </h4>
              </div>
              <p className="text-xs text-emerald-200">
                Jika Anda bermaksud menyalurkan dana infaq rutin bulanan dalam
                jumlah tertentu melalui autodebet atau m-banking dengan nominal
                tetap, silakan salurkan ke rekening DKM resmi berikut:
              </p>
              <div className="bg-emerald-950/70 p-4 rounded-xl border border-emerald-800/50 flex flex-col justify-between relative group w-full">
                <div>
                  ...
                  <span className="block text-sm font-extrabold tracking-wider font-mono text-white mt-1">
                    7140-259227
                  </span>
                  <span className="block text-[10px] text-emerald-300/80 mt-0.5">
                    A/N UPZ Masjid Raya Puri Telukjambe
                  </span>
                </div>
                <button
              ...
              <div className="flex items-center gap-2 text-[10px] text-emerald-300/80 bg-emerald-950/40 p-2.5 rounded-lg border border-emerald-900">
                ...
                <span>
                  Harap tambahkan kode unik *01* di akhir nominal transfer Bank
                  (contoh: Rp 100.001) untuk memudahkan verifikasi pelaporan DKM
                  otomatis.
                </span>
              </div>
            </div>
